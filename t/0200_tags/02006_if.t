...
is(Liquid::Template->parse(<<'INPUT')->render(), <<'EXPECTED', '1 == 1');
...
EXPECTED
is(Liquid::Template->parse(<<'INPUT')->render(), <<'EXPECTED', q[1 < 2]);
{% if 1 < 2 %}Yep.{% endif %}
INPUT
Yep.
EXPECTED
...
EXPECTED
is(Liquid::Template->parse(<<'INPUT')->render(), <<'EXPECTED', '5 = 5');
